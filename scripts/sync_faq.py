...
def build_bundle(output, versions=VERSIONS, refs=None, reader=fetch, captured_on=None):
    ...
    files["ATTRIBUTION.md"] = ("# Third-party Milvus FAQ material\n\n"
        ...
        "This notice covers the bundled third-party documentation. Milvus Doctor's own code and project-authored Skill documentation are separately licensed under Apache-2.0; see the repository-root [LICENSE](../../LICENSE).\n").encode()
    output.mkdir()
